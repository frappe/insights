...
| # | Question | Read from |
|---|---|---|
| 1 | Can the data store be the default sync path | `site_tables`: `charts_fit / charts_total`, `tables_over_limit` |
