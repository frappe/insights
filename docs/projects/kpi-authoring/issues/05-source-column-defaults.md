...
The builder writes an explicit column list when it creates a source operation. The list holds the doctype's own fields. Meta columns are available and unchecked.
