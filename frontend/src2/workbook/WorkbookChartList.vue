...
import { BarChart2, Plus, X } from 'lucide-vue-next'
	...
	<div class="flex flex-col gap-2 px-2.5 py-2">
		<div class="flex h-6 items-center justify-between">
			<div class="flex items-center gap-1">
				<div class="text-[11px] uppercase">Charts</div>
			</div>
			<div>
				<button
					class="cursor-pointer rounded p-1 transition-colors hover:bg-gray-100"
					@click="workbook.addChart()"
				>
					<Tooltip text="New Query" :hover-delay="0.1">
		...
		<div
			v-if="!workbook.doc.charts.length"
