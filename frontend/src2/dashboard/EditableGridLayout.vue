...
//
// It names the grid the gesture started from as well: that grid is settled and
// this one is not always, so the parent cannot work out which cells moved from
// the stored layout alone.
const emit = defineEmits<{
	move: [key: BreakpointKey, layouts: Layout[], from: Layout[]]
}>()
