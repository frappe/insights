						...
						<thead class="sticky top-0 text-gray-600">
							<tr>
								<th
									...
									:key="column.name"
									class="whitespace-nowrap border-b border-r bg-gray-100 py-1.5 pl-3 font-medium text-gray-700"
									scope="col"
								>
									<ColumnHeader :column="column" :query="query" />
								</th>
								<th
									class="border-b bg-gray-100 py-1.5 pl-3 font-medium text-gray-700"
									scope="col"
									width="99%"
								></th>
							</tr>
						...
						>
							<tr v-for="(row, i) in formattedResult" :key="i">
								<td
									v-for="(cell, j) in row"
									:key="j"
									class="whitespace-nowrap border-b border-r bg-gray-50 py-2 pl-3 text-gray-600"
								...
								<td
									class="border-b bg-gray-50 py-2 pl-3 text-gray-600"
									width="99%"
								></td>
							</tr>
						</tbody>
