<template>
	<div class="flex h-full w-full items-center justify-center rounded-md bg-gray-50">
		<div v-if="show" class="relative flex h-full w-full bg-white">
...
const show = computed(() => {
	return item && item.component && item.componentProps
})
</script>
