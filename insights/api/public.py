...
def get_public_key(resource_type, resource_name):
    from insights.insights_v2.doctype.insights_chart.insights_chart import (
        get_chart_public_key,
    )
    from insights.insights_v2.doctype.insights_dashboard.insights_dashboard import (
...
def get_public_dashboard_chart_data(public_key, *args, **kwargs):
    ...
    kwargs.pop("cmd")
    return frappe.get_cached_doc("Insights Dashboard", dashboard_name).fetch_chart_data(*args, **kwargs)
